<?php
	...
	if (isset($_POST['submit']) && isset($_POST['catagory']) && !empty($_POST['catagory']) ){
		...
		$sql 			= 'INSERT INTO halls (`hname`,`tlink`) VALUES (\''.$title.'\',\''.$tlink.'\')';
			...
			<div class="col-md-6">
				...
				<form action="" method="POST" enctype="multipart/form-data">
					<div class="form-group">
						<label for="Subject_title">Hall Name</label>
						<input type="text" class="form-control" id="catagory" name="catagory" placeholder="Title">
					</div>
					<br>
					<div class="form-group">
						<label for="Subject_title">Ticket Booking Link</label>
						<input type="text" class="form-control" id="tlink" name="tlink" placeholder="Title">
					</div>		
<br>					
