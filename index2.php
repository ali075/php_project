...
<div>				
 ...
 <tr>
  	...
  	<td width="220"><a href="index1.php?page=<?php echo $dd?>"><img src="Leisure Guide TV and Cinema/arrows.png" height="20" width="20"></a></td>  
   	<td width="380">3.00 pm</td>
    <td width="400">4.00 pm</td>
    <td width="360">5.00 pm</td>
	<td width="350">6.00 pm</td>
	<td width="80"><a href="index3.php?page=<?php echo $dd?>"><img src="Leisure Guide TV and Cinema/right arrow.png" height="20" width="20"></a></td>
  </tr>
...
<table width="810" bgcolor="#FFFFE8" border="1" style=" font-size:14px;">
  <tr>
	<?php
		...
		$rows = $connection->query("SELECT * FROM tv_program WHERE time BETWEEN '15:00:00' and '19:59:00' and pid='$dd' and channel_name_id=1 order by time");
  ...
  <tr>
   <?php
		...
		$connection 	= new mysqli('localhost', 'root', '', 'leisureguide');
		$rows = $connection->query("SELECT * FROM tv_program WHERE time BETWEEN '15:00:00' and '19:59:00' and pid='$dd' and channel_name_id=2 order by time");
		$connection->close();
 ...
 <?php
  ...
  <tr>
   <?php
		...
		$connection 	= new mysqli('localhost', 'root', '', 'leisureguide');
		$rows = $connection->query("SELECT * FROM tv_program WHERE time BETWEEN '15:00:00' and '19:59:00' and pid='$dd' and channel_name_id=3 order by time");
		$connection->close();
 ...
 <?php
  ...
  <tr>
   <?php
		...
		$connection 	= new mysqli('localhost', 'root', '', 'leisureguide');
		$rows = $connection->query("SELECT * FROM tv_program WHERE time BETWEEN '15:00:00' and '19:59:00' and pid='$dd' and channel_name_id=4 order by time");
		$connection->close();
 ...
 <?php
  ...
  <tr>
   <?php
		...
		$connection 	= new mysqli('localhost', 'root', '', 'leisureguide');
		$rows = $connection->query("SELECT * FROM tv_program WHERE time BETWEEN '15:00:00' and '19:59:00' and pid='$dd' and channel_name_id=5 order by time");
 ...
 <?php
  ...
  <tr>
   <?php
		...
		$connection 	= new mysqli('localhost', 'root', '', 'leisureguide');
		$rows = $connection->query("SELECT * FROM tv_program WHERE time BETWEEN '15:00:00' and '19:59:00' and pid='$dd' and channel_name_id=6 order by time");
		$connection->close();
