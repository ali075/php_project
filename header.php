	...
	<div class="header-top">
		...
		<div class="bottom-top">
			...
			<div class="search-box">
				<form method="get" action="Leisure Geuide TV and Cinema.html">
					<input type="hidden" name="page" value="csearch">
					<input type="hidden" name="cx" value="012420767386389925125:39rv31uvjmk">
			...
			<div class="daytime">
				...
				<a href="#" style="padding-left:0px"><img src="Leisure Guide TV and Cinema/go btn.png" height="30" width=".1"></a>
			</div>
